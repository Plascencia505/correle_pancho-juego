...
const int PROGMEM scores_melodia[][2] = {
  ...
  { C5, DUR_E }, { E5, DUR_E }, { G5, DUR_E }, { E5, DUR_E },
  { C5, DUR_E }, { E5, DUR_E }, { G5, DUR_Q }, { F5, DUR_E },
  { A5, DUR_E }, { C6, DUR_E }, { A5, DUR_E }, { F5, DUR_E },
  { A5, DUR_E }, { C6, DUR_Q }, { G5, DUR_E }, { B5, DUR_E },
  { D6, DUR_E }, { B5, DUR_E }, { G5, DUR_E }, { D6, DUR_E },
  { B5, DUR_Q }, { C6, DUR_E }, { B5, DUR_E }, { A5, DUR_E },
  { G5, DUR_E }, { E5, DUR_E }, { C5, DUR_Q }, { C5, DUR_E },
  { E5, DUR_E }, { G5, DUR_E }, { E5, DUR_E }, { C5, DUR_H },
  { REST, DUR_H },
};
...
const int PROGMEM juego_melodia[][2] = {
  ...
  { A4, DUR_S }, { G4, DUR_E }, { E4, DUR_E }, { C4, DUR_S },
  { D4, DUR_S }, { G4, DUR_H }, { G4, DUR_S }, { G4, DUR_S },
  { G4, DUR_E }, { G4, DUR_S }, { A4, DUR_S }, { G4, DUR_E },
  { E4, DUR_E }, { REST, DUR_H }, { REST, DUR_E }, { C5, DUR_E },
  { B4, DUR_S }, { A4, DUR_S }, { G4, DUR_E }, { E4, DUR_E },
  { D4, DUR_E }, { E4, DUR_S }, { F4, DUR_S }, { G4, DUR_H },
  { A4, DUR_E }, { G4, DUR_S }, { F4, DUR_S }, { E4, DUR_E },
  { C4, DUR_E }, { D4, DUR_H }, { G4, DUR_H }, { E5, DUR_E },
  { D5, DUR_S }, { C5, DUR_S }, { B4, DUR_E }, { A4, DUR_E }, 
  { G4, DUR_E }, { A4, DUR_S }, { B4, DUR_S }, { C5, DUR_H },
  { D5, DUR_E }, { C5, DUR_S }, { B4, DUR_S }, { A4, DUR_E },
  { G4, DUR_E }, { F4, DUR_E }, { G4, DUR_S }, { A4, DUR_S },
  { G4, DUR_H },
};
...
const int PROGMEM gameover_melodia[][2] = {
  { E4, DUR_S }, { REST, DUR_S }, { E4, DUR_S }, { G4, DUR_S },
  { E4, DUR_S }, { REST, DUR_S }, { G4, DUR_S }, { REST, DUR_S },
  { A4, DUR_E }, { A4, DUR_S }, { REST, DUR_S }, { A4, DUR_E },
  { E4, DUR_S }, { REST, DUR_S }, { E4, DUR_S }, { G4, DUR_S },
  { E4, DUR_S }, { REST, DUR_S }, { F4, DUR_S }, { FS4, DUR_S },
  { G4, DUR_E }, { A4, DUR_E }, { REST, DUR_E }, { C5, DUR_E },
  { B4, DUR_S }, { REST, DUR_S }, { A4, DUR_E }, { G4, DUR_S }, 
  { REST, DUR_S }, { FS4, DUR_S }, { G4, DUR_S }, { A4, DUR_E },
  { REST, DUR_E }, { G4, DUR_E }, { REST, DUR_S }, { G4, DUR_S },
  { A4, DUR_E }, { G4, DUR_E }, { E4, DUR_H }, { D4, DUR_H },
...
const int PROGMEM record_melodia[][2] = {
  ...
  { D5, DUR_S }, { E5, DUR_E }, { REST, DUR_S }, { C5, DUR_S },
  { E5, DUR_E }, { G5, DUR_W },
};
